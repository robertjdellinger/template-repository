...
output_file: "Docs/01-template-rmarkdown.pdf"  # Output file name
header-includes:
  # Set page margins and use double-spacing 
  - \usepackage{geometry}
  - \geometry{left=1in, right=1in, top=1in, bottom=1in, textwidth=6in}
  - \usepackage{setspace}
  - \doublespacing
  ...
  - \usepackage{microtype}  # For including graphics
  # Ensure content starts on a new page after the TOC
  - \usepackage{titlesec}
  - \titleformat{\section}[block]{\normalfont\Large\bfseries\centering}{\thesection}{1em}{}
  - \usepackage{fancyhdr}
  - \fancyfoot[C]{\thepage}  # Centered page number
  - \newpage  # Forces a page break after the table of contents
---
