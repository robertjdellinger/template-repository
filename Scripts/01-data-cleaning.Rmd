...
```{r literature-cited, echo=FALSE, results='asis'}
...
# Print BibTeX formatted entries (these will be included in the final rendered document)
cat("\n```bibtex\n")
cat(readLines(here(references_path, "references.bib")), sep = "\n")
cat("\n```")

# Optionally cite data sources here
cat("\n\n### Data Sources\n")
