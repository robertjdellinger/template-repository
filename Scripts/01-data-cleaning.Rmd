...
geometry: margin=1in, textwidth=6.5in  # Set margin and text width for better text fitting
output:
  pdf_document:
    toc: true  # Table of contents
    toc_depth: 3  # Set TOC depth
    number_sections: false  # Enable section numbering for better navigation
    fig_caption: true  # Enable figure captions
    fig_width: 6  # Set figure width
    fig_height: 4  # Set figure height
    keep_tex: false  # Don't keep intermediate .tex files
    latex_engine: xelatex  # Use xelatex for better font handling and unicode support
bibliography: "References/references.bib"  # Path to the bibliography file for citations
csl: "references/apa.csl"  # Path to CSL file for APA citation style
cache: false  # Disable caching for clean document builds
header-includes:
  ...
  - \fancyhead[C]{Template RMarkdown File}  # Center header
  ...
  - \usepackage{graphicx}  # For including and adjusting graphics
  - \usepackage[font=small,labelfont=bf]{caption}  # Customize figure captions
  - \usepackage{microtype}  # Improves text justification and kerning
  # Improve typography and PDF output
  - \usepackage{fontspec}  # Use system fonts with XeLaTeX
  - \setmainfont{Georgia}  # Set a nice, readable serif font (e.g., Georgia or Roboto)
  - \usepackage{hyperref}  # For clickable links in the PDF
  # Fine-tuning typography
  - \usepackage{parskip}  # Adds space between paragraphs and avoids indentation
