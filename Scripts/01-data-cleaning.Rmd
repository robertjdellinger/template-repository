...
references_path <- here("Docs", "References")
...
print(sessioninfo[1]$platform)
print(sessioninfo[2]$packages)

# Save session info to a CSV file
write.csv(sessioninfo[1]$platform, here(references_path, "session_info.csv"))
write.csv(sessioninfo[2]$packages, here(references_path, "session_info_packages.csv"))
