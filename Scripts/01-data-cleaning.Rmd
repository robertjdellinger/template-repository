...
Packages cited are @R-ggplot2, @R-tidyverse, @R-dplyr, @R-tidyr, @R-janitor, @R-lubridate, @R-glue, @R-purrr, @R-here, @R-gganimate, @R-ggrepel, @R-ggtext, @R-scales, @R-kableExtra, @R-cowplot, @R-patchwork, @R-plotly, @R-sf, @R-tigris, @R-raster, and @R-knitr.
